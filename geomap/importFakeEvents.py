...
def createEvents(lat_NW, lng_NW, lat_SE, lng_SE):
    ...
    for event in events:
        ...
        newEvent.valid_until = timezone.now() + datetime.timedelta(0, random.uniform(300.0, 600.0)*60)
...
createEvents(lat_NW, lng_NW, lat_SE, lng_SE)
